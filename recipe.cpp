...
Recipe::Recipe() : m_a(), m_b(), m_result(), m_level(0), m_icon() {}
Recipe::Recipe(const QString &a, const QString &b, const QString &result, int level, const QString &icon)
    : m_a(a), m_b(b), m_result(result), m_level(level), m_icon(icon) {}
...
Element Recipe::createResult() const {
    ...
    return Element(m_result, m_level, t, m_icon);
}
